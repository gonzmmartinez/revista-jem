...
\fancyhead[C]{\scshape Memorias de las VII JEM - 2023\\ \vspace{1mm} \hrule \vspace{1mm}
	\scshape\scriptsize \articulotitulo}
\fancyhead[L]{}
...
\fancypagestyle{portadapage}{
	\fancyhf{}
	\renewcommand{\headrulewidth}{0pt}
	\fancyhead[C]{\scshape Memorias de las VII JEM - 2023}
